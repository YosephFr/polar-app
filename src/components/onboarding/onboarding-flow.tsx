      ...
      <form onSubmit={submit} noValidate className="min-w-0 rounded-[1.75rem] border border-polar/10 bg-panel p-5 shadow-card sm:p-8">
        ...
        <div className={step === 2 ? "page-enter block" : "hidden"} aria-hidden={step !== 2}>
          ...
          <div className="mt-4 grid min-w-0 grid-cols-1 gap-4 min-[440px]:grid-cols-2">
            ...
            <Field label="Once / merienda" htmlFor="ratio-afternoon" error={fieldErrors.ratioAfternoonSnack}><Input id="ratio-afternoon" name="ratioAfternoonSnack" type="number" min="0" max="200" step="0.1" required onChange={() => clearError("ratioAfternoonSnack")} aria-invalid={Boolean(fieldErrors.ratioAfternoonSnack)} /></Field>
